...
object Main {
    ...
    def main() = {
      ...
      val p = <.p("You are looking at the page generated by the code on the left. " + title + " is a technology allowing you to either modify the code or the view. Try it now! Edit this paragraph!", <.br(),
